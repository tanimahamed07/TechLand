...
// CategoryTreeWithBrands - backend getCategoryTree response e brands array add kore
interface CategoryTreeWithBrands {
  _id: string;
  name: string;
  slug: string;
  image?: string;
...
export function Navbar() {
  ...
  const [categories, setCategories] = useState<CategoryTreeWithBrands[]>([]);
